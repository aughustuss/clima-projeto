  ...
  return (
    <>
      <div className=' bg-opacity-90 bg-cover bg-center flex items-center justify-center flex-col bg-slate-100 h-screen w-full'>
        <div className=' h-fit w-fit sm:w-3/4 md:w-2/4 lg:w-1/4 rounded-xl flex-col flex bg-violet-500 shadow-violet-900 shadow-md  bg-opacity-50ve' >
          <form onSubmit={handleSubmit} className='w-full h-1/6 flex justify-center items-center'>
            <div className='flex flex-row h-10 bg-transparent self-start mt-10 w-11/12' >
              <input value={city} onChange={handleChange} placeholder='Digite uma cidade:' type="text" className='capitalize text-center text-white w-10/12 bg-transparent rounded-l border border-slate-300 hover:cursor-pointer ' />
