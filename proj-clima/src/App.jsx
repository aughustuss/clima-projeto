...
function App() {
  ...
  return (
    <>
      <div style={{ backgroundImage: `url(${backimg})`, backgroundSize: 'object-fit' }} className='flex items-center justify-center flex-col bg-slate-50 h-screen w-full'>
        <div className='text-black h-3/4 w-fit sm:w-3/4 md:w-2/4 lg:w-1/4 rounded-xl flex-col flex bg-neutral-100 shadow-sky-900 shadow-sm  max-h-fit' >
